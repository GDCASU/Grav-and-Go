...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UICircle : UIPrimitiveBase
    {
        ...
        public bool multipleArcs = true; //true for testing

        public Vector3 leftVertex;
        public Vector3 rightVertex;
        public Vector3 middleVertex;
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            outerDiameter = -rectTransform.pivot.x * Diameter;
            ...
            middleVertex = vertices[vertices.Count / 2].position;
        ...
        {
            print("outer diameter" + outerDiameter);
        }
    }
}