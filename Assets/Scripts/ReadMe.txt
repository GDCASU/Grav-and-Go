...
## Data Persistence: 
These scripts include attributes, interfaces, and other scripts that will
include data outside the current scene. 

## Mechanics: 
These scripts are what bring our game to life. Things like traps, npcs,
and actions will be created here. 
...
## VFX:
This folder contains scripts for visual effects like the gravity gun
bezier lines.
